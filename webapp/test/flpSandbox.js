		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#atclouddnastudent05zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnastudent05zhoui5-display": {
								"semanticObject": "atclouddnastudent05zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.student05.zhoui5",
									"url": sap.ui.require.toUrl("at/clouddna/student05/zhoui5")
								}
							}
						}
					}
